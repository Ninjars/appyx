...
import com.bumble.appyx.multiplatform.core.children.ChildNodeCreationManager
...
abstract class ParentNode<NavTarget : Any>(
    ...
    childKeepMode: ChildEntry.KeepMode = com.bumble.appyx.Appyx.defaultChildKeepMode,
    ...
    fun PermanentChild(
        navTarget: NavTarget,
        decorator: @Composable (ChildRenderer) -> Unit
    ) {
